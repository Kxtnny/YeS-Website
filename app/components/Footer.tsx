...
const SOCIAL_LINKS: SocialLink[] = [
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/yesorgsg",
    icon: <LinkedInIcon />,
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/yesorgsg/",
    icon: <InstagramIcon />,
  },
  {
    label: "Telegram",
    href: "https://t.me/yesorgsg",
    icon: <TelegramIcon />,
  },
];
            ...
            {SOCIAL_LINKS.map((link) => (
              <li key={link.href}>
                <Link
                  ...
                  className="inline-flex size-10 items-center justify-center rounded-full text-white transition-colors hover:bg-white/15 hover:text-white"
                >
                  {link.icon}
                </Link>
              </li>
